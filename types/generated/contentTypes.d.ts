...
export interface ApiHelloHello extends Struct.CollectionTypeSchema {
  collectionName: 'hello_data';
  info: {
    singularName: 'hello';
    pluralName: 'hello-data';
    displayName: 'hello';
    description: '';
  };
  options: {
...
export interface ApiTest3Test3 extends Struct.CollectionTypeSchema {
  collectionName: 'test3s';
  info: {
    singularName: 'test3';
    pluralName: 'test3s';
    displayName: 'test3';
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::test3.test3'>;
  };
}
